export const ReutersNewsGroup = {
	image:        'reuters.gif',
	title:        'Reuters',
	description:  'Reuters news agency feeds',
	group:        'tv',
	category:     'News',
	path:         '/news/reuters',
	country:      'World',
...
export const ReutersNewsFeeds = [
  {
    title: 'News',
    feeds: [
      {
        label: 'Arts',
        title: 'Arts news on Reuters',
        path: '/news/reuters/arts',
        url: 'http://feeds.reuters.com/news/artsculture?format=xml'
      },
      {
        label: 'Business',
