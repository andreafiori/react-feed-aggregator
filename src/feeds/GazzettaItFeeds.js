...
export const GazzettaItNewsGroup = {
	image:        'gazzettait.gif',
	title:        'Gazzetta dello Sport',
	description:  'Gazzetta.it news feeds',
	group:        'sport',
	category:     'Italy',
...
export const GazzettaItNewsFeeds = [
  {
    title: 'Categories',
    feeds: [
      {
        label: 'Tutte le notizie',
        path: '/sport/gazzetta-it/all-news',
        url: 'https://www.gazzetta.it/rss/home.xml'
      },
      {
        label: 'Calcio',
        path: '/sport/gazzetta-it/calcio',
        url: 'https://www.gazzetta.it/rss/calcio.xml'
      },
      {
        label: 'Serie A',
        path: '/sport/gazzetta-it/serie-a',
        url: 'https://www.gazzetta.it/rss/serie-a.xml'
      },
      {
        label: 'Serie B',
        path: '/sport/gazzetta-it/serie-b',
        url: 'https://www.gazzetta.it/rss/serie-b.xml'
      },
      {
        label: 'Calcio Mercato',
        path: '/sport/gazzetta-it/calcio-mercato',
