...
// List https://blog.feedspot.com/video_game_rss_feeds/
export const VideoGamesWebsitesFeeds = [
  {
    ...
    feeds: [
      ...
      /* {
        ...
        url: 'http://blog.us.playstation.com/feed'
      }, */
      {
        label: 'Nintendo Life',
      ...
      {
        label: 'Polygon',
        title: 'Polygon RSS Feed',
        path: '/videogames/websites/polygon',
      ...
      },
      {
        ...
        path: '/videogames/websites/astrogaming-blog',
        website: '',
        facebook: '',
        twitter: '',
        youtube: '',
