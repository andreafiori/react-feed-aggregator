export const AntivirusNewsGroup = {
	image: 				'antivirus.gif',
	title: 				'Antivirus',
	description:	'Latest Antivirus and related information security news',
	group: 				'websites',
	category: 		'Infosec',
	path: 				'/cyber-security/antivirus',
	country: 			'World',
	website: 			'',
	youtube: 			'',
	facebook: 		'',
...
export const AntivirusNewsFeeds = [
	{
		title: 'Websites',
		feeds: [
			{
				...
				path: '/cyber-security/antivirus/mcafee-antivirus',
			...
			},
			{
				...
				path: '/cyber-security/antivirus/symantec',
			...
			{
				label: 'Trendmicro Blog',
				title: 'Trendmicro Blog RSS Feeds',
				path: '/cyber-security/antivirus/trendmicro',
				website: 'http://cyberdb.co/blog/',
				facebook: 'https://www.facebook.com/trendmicro',
				twitter: 'https://www.twitter.com/trendmicro',
				linkedin: 'https://www.linkedin.com/company/trend-micro',
				youtube: 'https://www.youtube.com/user/TrendMicroInc',
			...
			}, 
			{
				...
				path: '/cyber-security/antivirus/cyber-db',
				website: 'http://cyberdb.co/blog/',
			...
			}, 
			{
				...
				path: '/cyber-security/antivirus/securitywatch-blog',
			...
			},
			{
				...
				path: '/cyber-security/antivirus/compass-cyber-security',
			...
			},
			{
				...
				path: '/cyber-security/antivirus/binary-blogger',
				website: 'https://binaryblogger.com/',
				url: 'http://feeds.feedburner.com/binaryblogger'
			},
			{
				label: 'Quick Heal Antivirus',
				title: 'Quick Heal Antivirus RSS Feed',
				path: '/cyber-security/antivirus/quick-heal-antivirus',
				website: 'https://quickheal.com/',
			...
			},
			{
				...
				path: '/cyber-security/antivirus/it-security-expert',
			...
			},
			{
				...
				path: '/cyber-security/antivirus/privacy-ref-blog',
			...
			},
			{
				...
				path: '/cyber-security/antivirus/cyber-security-blog',
