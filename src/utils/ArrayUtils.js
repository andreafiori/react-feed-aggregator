export const isObjectsEqual = ((obj1, obj2) => {
  ...
  */
  ...
  return keys1.every ( ((kk) => {
    ...
    const v2 = obj2[kk];
    if ( Array.isArray(v1) )  {
      return isArraysEqual(v1, v2);
    } else if ( typeof v1 === "object" && v1 !== null) {
      return isObjectsEqual(v1, v2);
    } else {
      return v1 === v2;
    }
  }));
...
export const isArraysEqual = ((array1, array2) => {
  ...
  */
  ...
  return Array.prototype.every.call(array1, ((x, i) => {
      const y = array2[i];
      if ( Array.isArray(x) ) {
        return (!Array.isArray(y)) ? false : isArraysEqual(x, y);
      } else if ( typeof x === 'object' && typeof x !== null) {
        return ( !( typeof y === 'object' && typeof y !== null)) ? false : isObjectsEqual(x,y);
      } else {
        return (x === y);
      }
    })
